...
function verify(repository: string, args: string[] = [], env: NodeJS.ProcessEnv | null = null) {
  return spawnSync(process.execPath, [script, ...args], {
    cwd: repository,
    encoding: 'utf8',
    windowsHide: true,
    env: env ?? { ...process.env, GIT_AUTHOR_NAME: 'totec448-spec', GIT_AUTHOR_EMAIL: safeEmail },
  });
}
