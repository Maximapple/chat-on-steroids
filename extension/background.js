...
// marked response has grown, which is what 2.0.7 renews the manual handoff deadline on. Sent
// only alongside the field it describes, so a bare count can never move a deadline by itself.
